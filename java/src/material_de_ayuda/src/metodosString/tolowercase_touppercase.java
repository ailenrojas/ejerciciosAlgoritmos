...
public class tolowercase_touppercase {
	...
	public static void palabras() {
		...
		String apellido_mayu = apellido.toUpperCase(); // y este pasara cualquier letra que este en minuscula la pasara
														// a mayuscula

		System.out.println(nombre_min + "\n" + apellido_mayu);// y aca mostrara el resultado de los codigos anterior o
																// sea mostrara
